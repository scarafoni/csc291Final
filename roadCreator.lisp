...
(defun makeListHelper (l) (cond
	((null (cdr l)) nil)
	(t (append (list (list (concatenate 'string "r" (write-to-string (giveNext))) (car l) '1 (cadr l)) (list (concatenate 'string "r" (write-to-string (giveNext))) (cadr l) '1 (car l))) (makeListHelper (cdr l))))))

(defun makeList (l) (cond
	((null l) nil)
	(t (append (makeListHelper (car l)) (makeList (cdr l))))))

(print (makeList miniList))
(print miniList)
